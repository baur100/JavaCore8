...
public class App15 {
    public static void main(String[] args) {
        Address1 address = new Address1("6789 Bruck Willage", "Ancorige", "Alaska", 46510);
        ...
        insuranceCompanies.add(InsuranceCompanies.SOGAS);
        insuranceCompanies.add(InsuranceCompanies.INCOME_INSURANCE);
